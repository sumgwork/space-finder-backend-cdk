...
export class GenericTable {
  ...
  private addSecondaryIndeces() {
    if (this.tableProps.secondaryIndeces) {
      for (const secondaryIndex of this.tableProps.secondaryIndeces) {
